                    ...
                    <div class="border border-primary my-2 p-2">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="{{old('enslug')}}" name="enslug" placeholder="English slug Name.." required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="{{old('arslug')}}" name="arslug" placeholder="Arabic slug Name.." required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="{{old('trslug')}}" name="trslug" placeholder="Turkish slug Name.." required>
                            </div>
                        </div>
                    </div>

    ...
    <div>
        ...
        <form @submit.prevent="sendFeed">
            ...
            <div class="input-group mt-3">
                ...
                <input type="email" v-model="feed.email" class="form-control" :placeholder="local[lang+'.frontform']['menu']['email']+'..'" required />
            </div>
            ...
            <div class="input-group mt-3">
                ...
                <input type="text" v-model="feed.phone" class="form-control" :placeholder="local[lang+'.frontform']['menu']['phone']+'..'" required />
            </div>
            ...
            <div class="input-group mt-3">
                ...
                <select name="service" v-model="feed.service" class="form-control"  required >
                    ...
                    <option v-for="(item,index) in local[lang+'.frontform']['menu']['service']" :key="index" :value="item">{{item}}</option>
            ...
            <div class="input-group mt-3">
                ...
                <textarea v-model="feed.note" class="form-control" :placeholder="local[lang+'.frontform']['menu']['note']+'..'"  cols="30" rows="5" required>
    ...
    export default {
        ...
        methods: {
            sendFeed(){
                ...
                axios
                    .post(
                        CONFIG.API_URL + "front/form/forward",
                        this.feed
                    )
                    .then(res => {
                        this.loading = false;

...
@section('cover')
    <div class="row cover justify-content-center align-items-center">
       <div class="col-12 text-center">
           <img src="{{ asset('img/logo.png') }}" alt="{{__('seo.title')}}" title="{{__('seo.title')}}" height="100px">
           <br>
           <form class="my-3 justify-content-center" method="GET" action="{{ route('results') }}">
               <div class="input-group justify-content-center">
                   ...
                   <select name="category_id"  class="form-control-lg">
                       <option value="0" selected>{{__('fronthome.menu.category')}}</option>
                   ...
                   <select name="city"  class="form-control-lg">
                       <option value="0" selected>{{__('fronthome.menu.city')}}</option>

...
$(document).ready(function() {
    ...
    function init_template() {
        ...
        $('.shareToWhatsApp').prop("href", "https://api.whatsapp.com/send?phone=905538000036&text=" + share_link)
        $('.shareToMail').prop("href", "mailto:m.kadri@turkwizard.com?body=" + share_link)

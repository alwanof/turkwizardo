...
@section('header')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{$enCategory->name}}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
@section('content')
    <form method="POST" action="{{route('categories.store')}}">
        @csrf
        <input type="hidden" name="update" value="{{$enCategory->id}}">
                        ...
                        <div class="border border-primary my-2 p-2">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$enCategory->name}}" name="enname" placeholder="English Category Name.." required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$arCategory->name}}" name="arname" placeholder="Arabic Category Name.." required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$trCategory->name}}" name="trname" placeholder="Turkish Category Name.." required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="cropU">
                                    <div id="placeholder">
                                        <img src="{{$enCategory->cover}}" class="img-thumbnail" />
